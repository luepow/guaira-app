...
/**
 * Hero Section Component - Fixed for hydration
 *
 * Main landing page hero section with Guair.app logo
 */
                        ...
                        {[1, 2, 3].map((item) => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="text-white text-sm">Parquímetro #{999 + item}</div>
                              <div className="text-gray-400 text-xs">Hace {item}h</div>
                            </div>
                            <div className="text-white text-sm font-medium">-${item * 5}.00</div>
                          </div>
                        ))}
                      </div>
                    </div>
