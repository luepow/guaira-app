...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-secondary-900 to-primary-900">
          ...
          <div className="mx-4 my-4 px-4 py-3 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 group">
            <div className="flex items-center">
              ...
              <div className="ml-3 flex-1 min-w-0">
                ...
                <p className="text-xs text-white/70 truncate">{(session?.user as any)?.phone}</p>
              </div>
            </div>
          </div>
      ...
      <div className="lg:pl-64">
        ...
        <header className="sticky top-0 z-30 bg-gradient-to-r from-gray-800/95 via-secondary-800/95 to-primary-800/95 backdrop-blur-md border-b border-white/10 shadow-lg">
